					  ...
					  int32_t event_id, void *event_data)
{
	...
	ft_memcpy(&s_ip_addr, &event->ip_info.ip, sizeof(s_ip_addr));
...
static void start(void)
{
	...
	strcpy((char *)&wifi_config.sta.ssid, s_connection_name);
	strcpy((char *)&wifi_config.sta.password, s_connection_passwd);
...
{
	ft_strlcpy(s_connection_name, ssid, sizeof(s_connection_name));
	ft_strlcpy(s_connection_passwd, passwd, sizeof(s_connection_passwd));
